...
export const GET_RECHARGE_REPORT = 'GET_RECHARGE_REPORT';
export const SET_RECHARGE_REPORT = 'SET_RECHARGE_REPORT';
export const GET_SERVICE_USED_REPORT = 'GET_SERVICE_USED_REPORT';
export const SET_SERVICE_USED_REPORT = 'SET_SERVICE_USED_REPORT';
export const GET_EARNING_REPORT = 'GET_EARNING_REPORT';
...
export const GET_ASTROLOGER_CONSULTATION_PRICE = 'GET_ASTROLOGER_CONSULTATION_PRICE';
export const SET_ASTROLOGER_CONSULTATION_PRICE = 'SET_ASTROLOGER_CONSULTATION_PRICE';
...
export const GET_ASTROLOGER_ISSUES = 'GET_ASTROLOGER_ISSUES';
export const SET_ASTROLOGER_ISSUES = 'SET_ASTROLOGER_ISSUES';
export const GET_ASTROLOGER_LEAVE_REQUEST = 'GET_ASTROLOGER_LEAVE_REQUEST';
export const SET_ASTROLOGER_LEAVE_REQUEST = 'SET_ASTROLOGER_LEAVE_REQUEST';
export const APPROVE_REJECT_ASTROLOGER_LEAVE_REQUEST = 'APPROVE_REJECT_ASTROLOGER_LEAVE_REQUEST';
...
//! Astro-Puja
//* Puja Category
export const GET_PUJA_CATEGORY = 'GET_PUJA_CATEGORY';
export const SET_PUJA_CATEGORY = 'SET_PUJA_CATEGORY';
export const CREATE_PUJA_CATEGORY = 'CREATE_PUJA_CATEGORY';
export const UPDATE_PUJA_CATEGORY = 'UPDATE_PUJA_CATEGORY';
export const DELETE_PUJA_CATEGORY = 'DELETE_PUJA_CATEGORY';
//* Puja
...
export const GET_PUJA_REGISTER = 'GET_PUJA_REGISTER';
export const SET_PUJA_REGISTER = 'SET_PUJA_REGISTER';
export const APPROVE_PUJA_REGISTER = 'APPROVE_PUJA_REGISTER';
export const GET_PUJA_BOOKED = 'GET_PUJA_BOOKED';
export const SET_PUJA_BOOKED = 'SET_PUJA_BOOKED';
export const GET_PUJA_BOOKED_BY_ID = 'GET_PUJA_BOOKED_BY_ID';
export const SET_PUJA_BOOKED_BY_ID = 'SET_PUJA_BOOKED_BY_ID';
export const COMPLETE_REQUEST_PUJA = 'COMPLETE_REQUEST_PUJA';

//! Live Session
//? Category
export const GET_LIVE_SESSION_CATEGORY = 'GET_LIVE_SESSION_CATEGORY';
export const SET_LIVE_SESSION_CATEGORY = 'SET_LIVE_SESSION_CATEGORY';
export const CREATE_LIVE_SESSION_CATEGORY = 'CREATE_LIVE_SESSION_CATEGORY';
export const UPDATE_LIVE_SESSION_CATEGORY = 'UPDATE_LIVE_SESSION_CATEGORY';
export const DELETE_LIVE_SESSION_CATEGORY = 'DELETE_LIVE_SESSION_CATEGORY';
//? Topic
export const GET_LIVE_SESSION_TOPIC = 'GET_LIVE_SESSION_TOPIC';
export const SET_LIVE_SESSION_TOPIC = 'SET_LIVE_SESSION_TOPIC';
export const CREATE_LIVE_SESSION_TOPIC = 'CREATE_LIVE_SESSION_TOPIC';
export const UPDATE_LIVE_SESSION_TOPIC = 'UPDATE_LIVE_SESSION_TOPIC';
export const DELETE_LIVE_SESSION_TOPIC = 'DELETE_LIVE_SESSION_TOPIC';
...
export const CREATE_SLOT_DURATION = 'CREATE_SLOT_DURATION';
export const UPDATE_SLOT_DURATION = 'UPDATE_SLOT_DURATION';
export const DELETE_SLOT_DURATION = 'DELETE_SLOT_DURATION';

//? Predefined Message
export const GET_PREDEFINED_MESSAGE = 'GET_PREDEFINED_MESSAGE';
export const SET_PREDEFINED_MESSAGE = 'SET_PREDEFINED_MESSAGE';
export const CREATE_PREDEFINED_MESSAGE = 'CREATE_PREDEFINED_MESSAGE';
export const UPDATE_PREDEFINED_MESSAGE = 'UPDATE_PREDEFINED_MESSAGE';
...
export const CREATE_ASTRO_BLOG = 'CREATE_ASTRO_BLOG';
...
// Astro-Puja-Status
export const UPDATE_ASTRO_PUJA_STATUS = 'UPDATE_ASTRO_PUJA_STATUS'
export const UPDATE_ASTRO_PUJA_ASSIGN = 'UPDATE_ASTRO_PUJA_ASSIGN'
...
//Asto puja details
export const GET_PUJA_ORDER_ID = "GET_PUJA_ORDER_ID"
export const SET_PUJA_ORDER_ID = "SET_PUJA_ORDER_ID"
export const GET_ASTROLOGERS_REGISTERED_PUJA = "GET_ASTROLOGERS_REGISTERED_PUJA"
export const SET_ASTROLOGERS_REGISTERED_PUJA = "SET_ASTROLOGERS_REGISTERED_PUJA" 
