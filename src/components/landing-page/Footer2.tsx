...
const ResponsiveFooter: React.FC = () => {
  ...
  const importantLinks: FooterLink[] = [
    { id: "kundli", label: "How to read kundli",ourPage: false, href: `${baseUrl}/kundli` },
    { id: "kundli-matching", label: "Kundli Matching",ourPage: false, href: `${baseUrl}/kundli-matching` },
  ...
  const handleNewsletterSubmit = async (): Promise<void> => {
    ...
    try {
      ...
      console.log('Newsletter subscription:', { email: normalizedEmail });
  ...
  return (
    <footer className="bg-gradient-to-br mb-16 from-[#8B0000] via-[#A52A2A] to-[#8B0000] text-white">
      {/* Newsletter Section */}
